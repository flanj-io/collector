// Package flanjredaction is the collector's defense-in-depth redaction
// processor. It re-applies the Flanj redaction floor (internal/redact) to the
...
var typeStr = component.MustNewType("flanjredaction")
