// Package viniferaui is the localhost UI extension: it serves the embedded Vue
...
var typeStr = component.MustNewType("viniferaui")

// collectorVersion travels as X-Vinifera-Collector-Version on the flag POST. It
