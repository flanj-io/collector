...
func TestGuards(t *testing.T) {
	r := newRig(t)
	r.start(t)
	for _, path := range []string{"/api/flag", "/api/connect", "/api/threads/x/open", "/api/threads/x/close", "/api/threads/x/reopen", "/api/threads/x/replace-link", "/api/findings/x/resolve", "/api/findings/x/reopen", "/api/contracts/fetch", "/api/contracts/probe"} {
